...
@pytest.mark.parametrize(
    ...
    [
        (
            "nunchaku_flux1_redux_dev.py",
            0.9,
            0.137,
        ),
        ("nunchaku_flux1_dev_controlnet_upscaler.py", 0.9, 0.1, 18.9),
        ...
        ("nunchaku_flux1_shuttle_jaguar.py", 0.9, 0.157, 23.9),
        ...
        ("nunchaku_flux1_dev_qencoder.py", 0.9, 0.27, 16.3),
        ("nunchaku-flux1-dev-hand_drawn_game.py", 0.92, 0.254, 23),
    ],
)
